...
**[Bookstore] Bookstore is an app that allows the user to go through a list of books, add a new book and remove a book. It was built using React and Redux (state management).
...
```sh
  cd my-folder
  git clone git@github.com:aima98/Bookstore.git
```
...
- Project from [Microverse's](https://bit.ly/MicroverseTN) React Redux Module
